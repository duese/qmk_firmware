...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        case KC_LEFT_CTRL:
        case KC_RIGHT_CTRL:
            lunaIsSneaking = record->event.pressed;
            return true;
        case KC_SPACE:
            lunaIsJumping = record->event.pressed;
            if (lunaIsJumping) {
...
static void print_wpm_and_luna(void) {
    render_luna(0, 5);
