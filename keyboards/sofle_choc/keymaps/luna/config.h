...
// According to https://www.reddit.com/r/olkb/comments/rliiak/secondary_oled_non_master_on_a_split_kb_not/
// and https://github.com/qmk/qmk_firmware/blob/master/docs/feature_split_keyboard.md#data-sync-options
#define SPLIT_LAYER_STATE_ENABLE
#define SPLIT_LED_STATE_ENABLE
#define SPLIT_MODS_ENABLE
#define SPLIT_WPM_ENABLE
// If LED_MATRIX_KEYPRESSES or LED_MATRIX_KEYRELEASES is enabled,
// you also will want to enable SPLIT_TRANSPORT_MIRROR.
// Luna also needs it in case you're displaying her on the slave side.
